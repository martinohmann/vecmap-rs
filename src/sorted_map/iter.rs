use super::{Entries, Slot, SortedVecMap};
...
///
/// This `struct` is created by the [`iter`] method on [`SortedVecMap`].
///
/// [`iter`]: SortedVecMap::iter
...
///
/// This `struct` is created by the [`iter_mut`] method on [`SortedVecMap`].
///
/// [`iter_mut`]: SortedVecMap::iter_mut
...
///
/// This `struct` is created by the [`into_iter`] method on [`SortedVecMap`].
///
...
///
/// This `struct` is created by the [`keys`] method on [`SortedVecMap`].
///
/// [`keys`]: SortedVecMap::keys
...
/// An owning iterator over the keys of a [`SortedVecMap`].
///
/// This `struct` is created by the [`into_keys`] method on [`SortedVecMap`].
///
/// [`into_keys`]: SortedVecMap::into_keys
...
/// An iterator over the values of a [`SortedVecMap`] in sort order.
///
/// This `struct` is created by the [`values`] method on [`SortedVecMap`].
///
/// [`values`]: SortedVecMap::values
...
/// A mutable iterator over the values of a [`SortedVecMap`] in sort order.
///
/// This `struct` is created by the [`values_mut`] method on [`SortedVecMap`].
///
/// [`values_mut`]: SortedVecMap::values_mut
...
/// An owning iterator over the values of a [`SortedVecMap`] in sort order.
///
/// This `struct` is created by the [`into_values`] method on [`SortedVecMap`].
///
/// [`into_values`]: SortedVecMap::into_values
...
///
/// This `struct` is created by the [`range`] method on [`SortedVecMap`].
///
/// [`range`]: SortedVecMap::range
pub struct Range<'a, K, V> {
    iter: slice::Iter<'a, Slot<K, V>>,
}

impl<'a, K, V> Range<'a, K, V> {
    pub(super) fn new(entries: &'a [Slot<K, V>]) -> Range<'a, K, V> {
        Range {
            iter: entries.iter(),
        }
    }
...
impl_iterator!(Range<'a, K, V>, (&'a K, &'a V), Slot::refs);

/// A mutable iterator over a sub-range of entries in a [`SortedVecMap`].
///
/// This `struct` is created by the [`range_mut`] method on [`SortedVecMap`].
///
/// [`range_mut`]: SortedVecMap::range_mut
pub struct RangeMut<'a, K, V> {
    iter: slice::IterMut<'a, Slot<K, V>>,
}

impl<'a, K, V> RangeMut<'a, K, V> {
    pub(super) fn new(entries: &'a mut [Slot<K, V>]) -> RangeMut<'a, K, V> {
        RangeMut {
            iter: entries.iter_mut(),
        }
    }
...
/// A draining iterator for [`SortedVecMap`].
///
/// This `struct` is created by the [`drain`] method on [`SortedVecMap`].
///
/// [`drain`]: SortedVecMap::drain
pub struct Drain<'a, K, V> {
    iter: vec::Drain<'a, Slot<K, V>>,
}

impl<'a, K, V> Drain<'a, K, V> {
    pub(super) fn new<R>(map: &'a mut SortedVecMap<K, V>, range: R) -> Drain<'a, K, V>
    where
        R: RangeBounds<usize>,
    {
        Drain {
